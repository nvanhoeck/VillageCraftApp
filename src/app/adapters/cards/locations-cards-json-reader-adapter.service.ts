...
export class LocationsCardsJsonReaderAdapterService implements LocationCardsFetchPort {
  ...
  getAllCards(): Observable<LocationCard[]> {
    return of(JSON.parse(JSON.stringify(locationCards.data)) as LocationCard[])
  }
}
