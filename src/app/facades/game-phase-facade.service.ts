...
export class GamePhaseFacadeService implements EventHandler {
    constructor(
        private messageAdapterService: MessagesAdapterService,
        ...
        switch (event.type) {
            ...
            case 'GameInitiated':
                ...
                setTimeout(() => {
                    this.messageAdapterService.publish({
                        ...
                        subMessage:
                            'Exhaust the buildings to produce resources',
                    });
                }, 3001);
                break;
            case 'GamePhaseStarted':
                this.messageAdapterService.publish({
                    ...
                    subMessage:
                        'Play cards from hand, exhaust to build, claim location, attack and do special actions.',
                });
        }
    }
