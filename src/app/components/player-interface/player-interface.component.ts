...
export class PlayerInterfaceComponent {
    ...
    endTurnLabel$ = this.gamePhaseFacade
        .getGamePhase$(this.gameFacade.getGameId())
        .pipe(map(gamePhase => this.mapEndTurnLabelByGamePhase(gamePhase)));
    showEndTurn$ = this.gamePhaseFacade
        .getGamePhase$(this.gameFacade.getGameId())
        .pipe(map(gamePhase => this.mapShowEndTurnByPhase(gamePhase)));
